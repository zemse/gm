use crate::app::widgets::address_book_popup::AddressBookPopup;
use crate::app::widgets::form::FormItemIndex;
use crate::app::widgets::networks_popup::NetworksPopup;
use crate::app::widgets::tx_popup::TxPopup;
